...
<p class="text-slate-400 text-lg leading-relaxed mb-6">The COFINFAD Shiny application is built with a <strong class="text-white">navbar-based multi-page layout</strong> powered by <code class="text-primary bg-primary/10 px-1.5 py-0.5 rounded text-sm">bslib</code>. Each module occupies its own tab within a top-level navigation bar, and every tab follows a consistent <strong class="text-white">sidebar + main panel</strong> pattern — the sidebar provides analytics calibration controls (filters, sliders, dropdowns) while the main panel displays responsive output panels. All heavy computation is done offline; the app only loads pre-processed data and pre-trained models.</p>

<!-- Shiny Layouts & Components -->
<h4 class="text-xl font-bold text-white mb-4 flex items-center gap-2"><span class="material-symbols-outlined text-primary">dashboard</span> 5.1 Shiny Layouts &amp; Components</h4>

<div class="space-y-8 mb-10">

<!-- Layout Architecture -->
<div class="p-5 bg-[#0d0d0d] border border-white/5 rounded-xl">
<h5 class="font-bold text-slate-300 mb-3 text-sm uppercase tracking-wide">Layout Architecture</h5>
...
<div class="p-5 bg-[#0d0d0d] border border-white/5 rounded-xl">
<h5 class="font-bold text-slate-300 mb-3 text-sm uppercase tracking-wide">Calibration Input Components</h5>
<ul class="space-y-3 text-slate-400 text-sm">
...
<!-- Output Components -->
<div class="p-5 bg-[#0d0d0d] border border-white/5 rounded-xl">
<h5 class="font-bold text-slate-300 mb-3 text-sm uppercase tracking-wide">Output Components</h5>
<ul class="space-y-3 text-slate-400 text-sm">
<li><code class="text-primary">plotly::plotlyOutput()</code> — renders the interactive time-series line chart (Module 1), PCA scatter plot colour-coded by cluster (Module 2), elbow and silhouette diagnostic plots (Module 2), variable importance bar chart, and cross-validation &lambda;-vs-MSE curve (Module 3). Plotly provides hover tooltips, zoom, and brush selection across all charts.</li>
<li><code class="text-primary">leaflet::leafletOutput()</code> — renders the choropleth map of Colombian departments in Module 1, coloured by the user-selected metric (customer count, average churn probability, or average CLV). Users can zoom, pan, and click on departments to see detailed tooltips.</li>
<li><code class="text-primary">DT::DTOutput()</code> — displays the cluster summary statistics table in Module 2 (mean of each feature per cluster) and the current-vs-hypothetical comparison table in Module 3. Both tables are sortable, searchable, and paginated.</li>
<li><code class="text-primary">uiOutput()</code> — used for the statistical test result panel in Module 1 (dynamically renders test statistic, p-value, effect size, and interpretation) and the churn probability gauge in Module 3 (a reactive HTML gauge that updates as What-If sliders change).</li>
</ul>
</div>
...
<!-- Wireframe Sketches -->
<h4 class="text-xl font-bold text-white mb-4 flex items-center gap-2"><span class="material-symbols-outlined text-primary">draw</span> 5.2 Wireframe Sketches</h4>
<p class="text-slate-400 text-sm mb-6">Each wireframe shows the sidebar calibration controls on the left and the output panels on the right, illustrating how users interact with the analytics.</p>

<!-- Module 1 Wireframe -->
<div class="my-8">
<h5 class="font-bold text-blue-400 mb-3 text-sm uppercase tracking-wide">Module 1: EDA &amp; Confirmatory Data Analysis</h5>
...
<p class="font-bold text-blue-400 mb-2">How the user interacts with this tab:</p>
...
<!-- Module 2 Wireframe -->
<div class="my-8">
<h5 class="font-bold text-purple-400 mb-3 text-sm uppercase tracking-wide">Module 2: Customer Segmentation (Clustering)</h5>
<div class="flex justify-center mb-4">
...
<p class="font-bold text-purple-400 mb-2">How the user interacts with this tab:</p>
<ol class="list-decimal list-inside space-y-1.5">
...
<!-- Module 3 Wireframe -->
<div class="my-8">
<h5 class="font-bold text-green-400 mb-3 text-sm uppercase tracking-wide">Module 3: Churn Prediction (What-If)</h5>
<div class="flex justify-center mb-4">
...
<p class="font-bold text-green-400 mb-2">How the user interacts with this tab:</p>
<ol class="list-decimal list-inside space-y-1.5">
...
<!-- Inputs -->
<div>
<h4 class="text-xl font-bold text-white mb-6 flex items-center gap-2"><span class="material-symbols-outlined text-primary">tune</span> 5.3 Inputs (Calibration Controls)</h4>
...
<!-- Outputs -->
<div>
<h4 class="text-xl font-bold text-white mb-6 flex items-center gap-2"><span class="material-symbols-outlined text-primary">monitor</span> 5.4 Outputs</h4>
